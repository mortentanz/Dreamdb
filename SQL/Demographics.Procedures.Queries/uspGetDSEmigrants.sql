/*-----------------------------------------------------------------------------------------------------------
  $Archive: /SQL.root/SQL/Demographics.Procedures.Queries/uspGetDSEmigrants.sql $
  $Revision: 1 $
  $Date: 12/18/06 15:46 $
  $Author: mls $

  Procedure   : Demographics.uspGetDSEmigrants
  
  Purpose     : Gets number of emigrants for a specified range of years. Intended for the population 
...
-------------------------------------------------------------------------------------------------------------*/
IF object_id('Demographics.uspGetDSEmigrants', 'P') IS NOT NULL
DROP PROCEDURE Demographics.uspGetDSEmigrants
GO

CREATE PROCEDURE Demographics.uspGetDSEmigrants (
