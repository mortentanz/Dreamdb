/*-----------------------------------------------------------------------------------------------------------
  $Archive: /SQL.root/SQL/Demographics.Procedures.Queries/uspGetDSPopulation.sql $
  $Revision: 1 $
  $Date: 12/18/06 15:46 $
  $Author: mls $

  Procedure   : Demographics.uspGetDSPopulation
  
  Purpose     : Gets population cohor sizes for a specified range of years. Intended for the population 
...
-------------------------------------------------------------------------------------------------------------*/
IF object_id('Demographics.uspGetDSPopulation ', 'P') IS NOT NULL
DROP PROCEDURE Demographics.uspGetDSPopulation 
GO

CREATE PROCEDURE Demographics.uspGetDSPopulation (
